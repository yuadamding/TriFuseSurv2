...
from trifusesurv2.utils.data import PreprocessedContourAwareDataset
    ...
    *,
    ...
    for batch_idx, batch in enumerate(loader, start=1):
        ...
        with autocast_ctx():
            ...
            if aux is not None and "loc_pt_logits" in aux and mask_pt is not None and mask_ln is not None:
...
def run_one_fold(
    ...
    *,
    ...
    if str(getattr(args, "model_version", "v1")).strip().lower() == "v2":
        from trifusesurv2.models.contour_habitat_survival import ContourAwareHabitatSurvivalModel
        ...
        v2_backbone = ContourAwareROITokenBackbone(**backbone_cfg)
...
def parse_args():
    ...
    p.add_argument("--model_version", type=str, default="v1", choices=["v1", "v2"],
                   help="v1: SwinUNETR+MoE late-fusion; v2: habitat-aligned cross-attention")
