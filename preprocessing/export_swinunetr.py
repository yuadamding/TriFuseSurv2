...
1) DICOM cohort root (one folder per patient):
    /home/yding1995/Image/OPSCC/A0522/*.dcm  (CT + RTSTRUCT in same folder)
2) Survival table:
    /home/yding1995/Image/radiomics_figure/opscc_survival_time_event.csv
