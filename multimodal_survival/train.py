...
OUT=${TMPDIR:-/tmp/$USER}/moe_runs
mkdir -p "$OUT"

CUDA_VISIBLE_DEVICES=0 \
python -m trifusesurv.multimodal_survival.train \
  --meta_csv /rsrch8/home/bcb/yding4/radiomics/improve/OPSCC_preprocessed_128/cohort_preprocessed_with_clin.csv \
  --splits_dir /rsrch8/home/bcb/yding4/radiomics/improve/runs/opscc_splits_os_seed1 \
