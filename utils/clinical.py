"""Shared clinical feature encoder for TriFuseSurv2."""
...
PROGNOSTIC_CLINICAL_COLS = [
    "PATHOLOGY", "NSTAGE", "AGE", "SEX", "RACE",
    "T", "N", "M", "KFCF", "SMOKE", "ALCOHOL", "HPV",
]

TREATMENT_AWARE_CLINICAL_COLS = [
    "PATHOLOGY", "NSTAGE", "AGE", "SEX", "RACE",
    "T", "N", "M", "KFCF", "TX", "SMOKE", "ALCOHOL", "HPV",
]

# Default is prognostic (no TX) to avoid leaking treatment allocation
# into baseline prognosis models.
DEFAULT_CLINICAL_COLS = PROGNOSTIC_CLINICAL_COLS

# Re-exported from schema for backward compatibility.
from trifusesurv2.schema import ENDPOINT_MAP  # noqa: F401
